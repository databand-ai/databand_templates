...
REDSHIFT_CONN_ID = Variable.get("redshift_db_monitor_conn_id")
DAG_ID = Variable.get("redshift_db_monitor_DAG_id")
MONITOR_SCHEDULE = Variable.get("redshift_db_monitor_schedule")
TARGET_SCHEMA = Variable.get("target_redshift_schema")
